...
#					)
	...
	def cbQRTag(self):
		...
		# Color thresholding
		ret,self.thresh = cv2.threshold(self.blurred, 60, 255, cv2.THRESH_BINARY_INV)
		
		# Find the contours of the frame
		contours = cv2.findContours(self.thresh.copy(), 1, cv2.CHAIN_APPROX_NONE)[1]
...
#					)
		...
		cv2.imshow("Line Detection", self.cv_image_clone)

...
class CameraAprilTag:
	def __init__(self):
		...
		rospy.logwarn("QR Detection Node [ONLINE]...")
	...
	def cbQRTag(self):
		...
		# QR Detection
		result = pyzbar.decode(cv_image_gray)
...
#			bottomLeftOrigin)
	...
	def cbShowImage(self):
		...
		cv2.imshow("QR Detection", self.cv_image_clone)
		cv2.waitKey(1)
	...
	def cbShutdown(self):
		rospy.logerr("QR Detection Node [OFFLINE]...")
